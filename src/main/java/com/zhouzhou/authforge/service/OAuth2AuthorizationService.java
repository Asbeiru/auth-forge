...
public interface OAuth2AuthorizationService {
     ...
     * @return 授权记录
     */
    OAuthAuthorization validateAuthorizationCode(String code, String clientId, String redirectUri);
     ...
     */
    void invalidateAuthorization(OAuthAuthorization authorization);
